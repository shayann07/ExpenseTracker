  ...
  protected SupportSQLiteOpenHelper createOpenHelper(@NonNull final DatabaseConfiguration config) {
    final SupportSQLiteOpenHelper.Callback _openCallback = new RoomOpenHelper(config, new RoomOpenHelper.Delegate(1) {
      ...
      public void createAllTables(@NonNull final SupportSQLiteDatabase db) {
        db.execSQL("CREATE TABLE IF NOT EXISTS `expense_table` (`id` INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, `amount` REAL NOT NULL, `category` TEXT NOT NULL, `note` TEXT NOT NULL, `date` TEXT NOT NULL)");
        db.execSQL("CREATE TABLE IF NOT EXISTS room_master_table (id INTEGER PRIMARY KEY,identity_hash TEXT)");
        db.execSQL("INSERT OR REPLACE INTO room_master_table (id,identity_hash) VALUES(42, '875c140139e941a4b2c599c8e43f4399')");
      }
      ...
      public RoomOpenHelper.ValidationResult onValidateSchema(
        ...
        final HashMap<String, TableInfo.Column> _columnsExpenseTable = new HashMap<String, TableInfo.Column>(5);
        ...
        if (!_infoExpenseTable.equals(_existingExpenseTable)) {
          return new RoomOpenHelper.ValidationResult(false, "expense_table(com.nayab.linearlayout.data.ExpenseEntity).\n"
                  + " Expected:\n" + _infoExpenseTable + "\n"
                  + " Found:\n" + _existingExpenseTable);
        }
        return new RoomOpenHelper.ValidationResult(true, null);
      }
    }, "875c140139e941a4b2c599c8e43f4399", "b612ec452ebda6e843c37006a16c1435");
